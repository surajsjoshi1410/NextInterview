...
const allQuestions = [
  {
    id: 1,
    question: "Procedural Knowledge in a rule-based system, is in the form of?",
    ...
    correctAnswer: "Yes",
    solution:
      "Rule-based systems use rules or conditions to make decisions based on input data.",
  },
  {
    id: 2,
    ...
    solution:
      "The Fibonacci sequence can be implemented using recursion or iteration.",
  },
  {
    id: 3,
...
const QuestionCollapsible = () => {
  ...
  const selectedQuestion =
    allQuestions.find((q) => q.id === Number(id)) || allQuestions[0];
        ...
        {selectedQuestion ? (
          <>
            <MetaInfo1>
              ...
              <Companies1>
                Companies: {selectedQuestion.companies.join(", ")}
              </Companies1>
            </MetaInfo1>
