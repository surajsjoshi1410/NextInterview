...
const MockTestsStats = () => {
    ...
    const monthlyChangePercentage = 2.45;
                ...
                <CardContent>
                    <div className='rowOne'>
                        <div className="rowOneLeft">
                            ...
                            <Typography className='rowOneLeftValue'>
                                2564
                            </Typography>
                        </div>
                        <div>
                        <Grid container spacing={1} justifyContent="space-between" alignItems="center" marginTop={2}>
