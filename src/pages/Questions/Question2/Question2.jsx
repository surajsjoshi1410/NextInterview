        ...
        <div>
            ...
            <Container>
                ...
                <Section>
                    ...
                    <Option
                        $isSelected={selectedOption === "No, planning to Switch to data/ai role"}
                        onClick={() => handleOptionChange("No, planning to Switch to data/ai role")}
                    >
                        <CirclePointer $isSelected={selectedOption === "No, planning to Switch to data/ai role"} />
                        <OptionLabel $isSelected={selectedOption === "No, planning to Switch to data/ai role"}>
                    ...
                    >
                        <CirclePointer $isSelected={selectedOption === "No, looking for my 1st job"} />
                        <OptionLabel $isSelected={selectedOption === "No, looking for my 1st job"}>
